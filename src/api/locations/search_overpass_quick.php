...
// Note: private.coffee moved to first position - more reliable than api.de (fewer 504 errors)
$endpoints = [
    // initial list; will be re-ordered by stats below
    'https://overpass.private.coffee/api/interpreter',  // Primary: reliable, good performance
    'https://overpass-api.de/api/interpreter',  // Fallback: complete data but frequent 504 timeouts
    'https://overpass.kumi.systems/api/interpreter'  // Additional fallback
];
